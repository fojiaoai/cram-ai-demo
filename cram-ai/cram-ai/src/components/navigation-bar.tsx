...
export default function NavigationBar({ className = '' }: NavigationBarProps) {
  ...
  const submitSearch = () => {
    ...
    if (!q) return
    navigate(`/unified-analysis?autostart=1&type=url&q=${encodeURIComponent(q)}`)
  }

  const navigationItems = [
    { key: 'home', path: '/dashboard', label: t('nav.home', 'Home') },
    { key: 'courses', path: '/my-courses', label: t('nav.myCourses', 'My Courses') },
    { key: 'exam', path: '/exam-interface', label: t('nav.exam', 'Exam') },
    { key: 'explore', path: '/explore', label: t('nav.explore', 'Explore') },
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="relative hidden lg:block">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 w-64 text-sm border border-gray-200 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
                value={searchValue}
            ...
            {/* Language Switcher (matches landing page) */}
            <LanguageSwitcher />

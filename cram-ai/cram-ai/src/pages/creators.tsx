          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <nav className="hidden md:flex space-x-6">
                ...
                <Link to="/unified-analysis" className="text-gray-600 hover:text-blue-600">
                  AI分析
                </Link>
                <Link to="/community" className="text-gray-600 hover:text-blue-600">
                  社区
                </Link>
                <Link to="/creators" className="text-blue-600 font-medium">
                  创作者
                </Link>
                <Link to="/exam-interface" className="text-gray-600 hover:text-blue-600">
                  考试
                </Link>
              </nav>
            </div>
